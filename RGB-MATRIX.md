...
Status: manual for a board that does not exist yet. `firmware/athena_matrix/` is empty; the driver submodule is declared in `.gitmodules` but not checked out. Build it against this document.
